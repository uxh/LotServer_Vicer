...
function Install()
{
  ...
  URLKernel='https://github.com/uxh/LotServer_Vicer/raw/master/lotServer.log'
  ...
  mkdir -p "${AcceTmp}/bin/"
  mkdir -p "${AcceTmp}/etc/"
  wget --no-check-certificate -qO "${AcceTmp}/bin/${AcceBin}" "https://github.com/uxh/LotServer_Vicer/raw/master/${MyKernel}"
  ...
  wget --no-check-certificate -qO "${AcceTmp}/etc/apx.lic" "https://api.52bwg.com/lotserver/keygen.php?ver=${acce_ver}&mac=${Mac}"
